...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String url) throws IOException {
        ...
        String jsonResponse = makeHttpRequest(earthquakeUrl);
...
//        String stringReader = readEarthquakeFromStream();
...
//            }
            ...
            return readEarthquakesArray(reader);
...
//        return earthquakes;
    ...
    public static ArrayList<Earthquake> readEarthquakesArray(JsonReader reader) throws IOException {
        /** Create an array to store the earthquakes list */
        ArrayList<Earthquake> earthquakes = new ArrayList<Earthquake>();
        ...
        while (reader.hasNext()) {
            ...
            if (name.equals("features")) {
                ...
                /** skip all values that are not under "features" key on root */
                reader.skipValue();
            }
        }
    ...
    public static Earthquake readEarthquake(JsonReader reader) throws IOException {
        ...
        Log.v("QueryUtils RE", "You are inside readEarthquake method");

        reader.beginObject();
        while (reader.hasNext()) {
            String name = reader.nextName();
            if (name.equals("mag")) {
                /** store double value of key mag to variable mag */
                mag = reader.nextDouble();
                Log.v("QueryUtils RE", "Earthquake Magnitude: " + mag);
            } else if (name.equals("place")) {
                /** store String value of key place to variable place */
                place = reader.nextString();
                Log.v("QueryUtils RE", "Earthquake Place: " + place);
            } else if (name.equals("time")) {
                /** store long value of key time to variable time */
                time = reader.nextLong();
                Log.v("QueryUtils RE", "Earthquake Time: " + time);
            } else if (name.equals("url")) {
                /** store string value of key url to variable url */
                url = reader.nextString();
                Log.v("QueryUtils RE", "Earthquake URL: " + url);
            } else {
        ...
        reader.endObject();
        /** Create new Earthquake object and return it */
        return new Earthquake(place, time, mag, url);
    }
...
//                extractEarthquakesFromInputStream(inputStream);
                jsonResponse = readEarthquakeFromStream(inputStream);
            } else {
     ...
     * parsing a JSON response.
     */
    public static ArrayList<Earthquake> extractEarthquakesFromInputStream(String inputStream) throws IOException {
     ...
     */
    public static String readEarthquakeFromStream(InputStream inputStream) throws IOException {
